...
public class Utility {
    ...
    public static void manipulateVisibility(AppCompatActivity activity, float slideOffset, View arrow_up,
        ...
        /*
        * Removed visibility based on our requirement
        */
    ...
    public static File writeImage(Bitmap bitmap, String path, int quality, int newWidth,
                                  int newHeight, ContextWrapper contextWrapper) {
        File dir = new File(getExternalStorage(contextWrapper), path);
        if (!dir.exists()) {
            dir.mkdirs();
        }
    ...
    public static void showAnswer(int a, int b) {
