...
public class Options implements Serializable {
    ...
    private boolean audioPermissionAsked = false;
    ...
    public Options setMediaClass(Class mediaClass) {
        check();
    ...
    public Boolean getAudioPermissionAsked() {
        return this.audioPermissionAsked;
    }

    public Options setAudioPermissionAsked(Boolean audioPermissionAsked) {
        check();
        this.audioPermissionAsked = audioPermissionAsked;
        return this;
    }
