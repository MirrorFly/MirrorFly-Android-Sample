    ...
    override fun onDialogClosed(dialogType: CommonAlertDialog.DIALOGTYPE?, isSuccess: Boolean) {
        if (isSuccess) {
            if (AppLifecycleListener.isPinEnabled) {
                ...
                intent.putExtra(Constants.GO_TO, com.contus.flycommons.Constants.LOGOUT_PIN)
                startActivityForResult(intent, com.contus.flycommons.Constants.ACTIVITY_REQ_CODE)
            } else {
