...
fun CallManager.isPinnedUserLeft(userJid: String = Constants.EMPTY_STRING) = CallUtils.getPinnedUserJid() == userJid || (isOneToOneCall() && CallUtils.getPinnedUserJid() == getCurrentUserId())
