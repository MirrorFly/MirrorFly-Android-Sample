...
object SharedPreferenceManager {
    ...
    fun clearAllPreference(isFromLogout: Boolean = false) {
        ...
        val autoDownloadEnabled =  getBoolean(com.contus.flycommons.SharedPreferenceManager.MEDIA_AUTO_DOWNLOAD)
        ...
        if (isFromLogout) {
            ...
            setBoolean(com.contus.flycommons.SharedPreferenceManager.MEDIA_AUTO_DOWNLOAD, autoDownloadEnabled)
