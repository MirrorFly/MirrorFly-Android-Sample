...
import com.contus.webrtc.api.CallLogManager.scope
...
class DriveHelper(private val mDriveService: Drive) {
    ...
    fun saveBackupFileFromDriveToLocal(
        ...
        try {
            ...
            request.mediaHttpDownloader.setProgressListener(listener).chunkSize = 1 * 0x100000
