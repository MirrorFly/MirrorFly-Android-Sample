...
class AudioRecordView(val chatParent: ChatParent) : AudioRecorder.AudioRecordingListener {
    ...
    private fun startRecord() {
        ...
        try {
            if (requestAudioFocus(focusChangeListener, AudioManager.USE_DEFAULT_STREAM_TYPE,
                ...
                mediaState = com.contus.flycommons.Constants.COUNT_ONE
            }
        } catch (e: Exception) {
            com.contus.flycommons.LogMessage.e(com.contus.flycommons.Constants.TAG, e)
        }
    }
    ...
    fun stopRecording() {
        try {
            ...
            mediaState = com.contus.flycommons.Constants.COUNT_ZERO
        } catch (e: Exception) {
            com.contus.flycommons.LogMessage.e(com.contus.flycommons.Constants.TAG, e)
        } finally {
