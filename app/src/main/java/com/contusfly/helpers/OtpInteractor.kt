 ...
 * @version 1.0
 */
internal class OtpInteractor(activity: Activity, private var otpBinding: ActivityOtpBinding, val apiCalls: ApiCalls, private val coroutineExceptionHandler: CoroutineExceptionHandler) : IOtpInteractor {
    ...
    /**
     * Store the api call for differentiate the api call reference
     */
    ...
    companion object {
        ...
        private const val BUILD_TYPE_DEBUG_QA = "qa"
    }
}